    ...
    <div class="container">
        ...
        %>
            ...
            <div class="d-flex justify-content-end">
                <button type="button" class="btn btn-outline-primary" onclick="location.href='${root }/notice/list'">글목록</button>

                <%
                    if (dto.getAuthor() == (int)session.getAttribute("userId")) {
                %>
                    <button type="button" class="btn btn-outline-success" onclick="location.href='${root }/notice/noticeUpdateForm?id=${dto.id}'">글수정</button>
    ...
    <script>
        document.getElementById("notice-delete").addEventListener("click", (e) => {
            if (confirm("정말 삭제하시겠습니까?")) {
                location.href='${root }/notice/noticeDelete?id=${dto.id}'
            }
        })
    </script>
</body>
