...
<body>
    ...
    <div class="container post-container">
        ...
        <div class="d-flex justify-content-between mb-4">
            <button class="btn btn-outline-primary btn-sm" style="width: 60px;" onclick="location.href='${root }/boards/boardCreateForm'">글쓰기</button>
        ...
        <table class="table table-hover text-center">
            ...
            <c:forEach var="board" items="${list}" varStatus="status">
                <tr>
                    ...
                    <td>
                        <a href="${root }/board/boardDetail?id=${board.getId()}">
                            ${board.getTitle()}
                        </a>
                    </td>
            ...
            .then(data => {
                ...
                if (data.data && data.data.length > 0) {
                    data.data.forEach((board, idx) => {
                        ...
                        row.innerHTML = `
                            <td>\${idx + 1}</td>
                            <td><a href="${root}/board/boardDetail?id=\${board.id}">\${board.title}</a></td>
