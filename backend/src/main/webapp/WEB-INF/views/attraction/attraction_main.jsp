...
<body>
	...
	<!--  카카오맵 API  -->
	<script defer type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=b62a7b977e891121b298d190876cda4a&autoload=false&libraries=services,clusterer,drawing"></script>
	<script src="/js/keys.js"></script>
	<script src="https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.7.5/proj4.js"></script>
	<script src="/js/common.js"></script>
	<script src="/js/KakaoMap.js"></script>
	<script src="${pageContext.request.contextPath}/js/attraction.js"></script>
	...
	<script>
		document.addEventListener("DOMContentLoaded", function () {
		   ...
		   regionSelect.addEventListener("change", function () {
		       ...
		       // AJAX 요청
		       fetch(`/guguns?sidoCode=` + sidoCode)
		           .then(response => {
		               if (!response.ok) {
